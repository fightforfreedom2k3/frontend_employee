...
import { Box, CircularProgress, Container, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Typography } from "@mui/material";

export default function DepartmentList() {
    const dispatch = useDispatch<AppDispatch>();
    const {departments, loading, pagination, error} = useSelector((state: RootState) => state.department);
    ...
    useEffect(() => {
        dispatch(fetchDepartments({page: page + 1, size: rowsPerPage, sort: "ASC", order: "createdAt"}))
