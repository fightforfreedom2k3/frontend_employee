...
export default function EmployeeDialog({ open, onClose, employeeId }: EmployeeDialogProps) {
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
            <DialogTitle>
                Thông tin nhân viên
                <Button onClick={onClose} sx={{ position: "absolute", right: 8, top: 8 }}>X</Button>
            </DialogTitle>
            <DialogContent dividers>
                {loading ? (
                    ...
                    <>
                        ...
                        <Typography><b>Mã số thuế:</b> {employee.taxCode}</Typography>
                        <Typography><b>Bảo hiểm xã hội:</b> {employee.insurance.socialInsuranceRate * 100}%</Typography>
                        <Typography><b>Bảo hiểm y tế:</b> {employee.insurance.healthInsuranceRate*100}%</Typography>
                        <Typography><b>Bảo hiểm thất nghiệp:</b> {employee.insurance.unemploymentInsuranceRate*100}%</Typography>
                    </>
                ) : (
